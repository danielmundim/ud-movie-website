...
class Movie():
    """
    Movie class used to instantiate movie objects to be
    used on creating the movies page
    """


    def __init__(self, movie_title, movie_storyline, poster_image, url_trailer):
        """
        Init function, runs once an instance is made, with all the correspondent
        parameters, sets the parameters passed through arguments to itself
    ...
    def show_trailer(self):
        """
        show_trailer: Opens the browser with the URL informed
        on it's "trailer" property
        """
